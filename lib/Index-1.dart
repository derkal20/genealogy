...
import 'package:nhom_11/home.dart';
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text('BỔ NHIỆM',style: TextStyle(fontWeight: FontWeight.w600,fontSize: 14,color: Colors.black),),
                          Padding(
                            padding: const EdgeInsets.only(top: 10,left: 20,right:20,bottom: 20),
                            child: Text('Bổ nhiệm cho Võ Thị Thu Thúy toàn quyền quyết định về quản lý và điều chỉnh những thay đổi trong gia tộc',textAlign: TextAlign.center,
                                ...
                                Padding(
                                  ...
                                  child: TextButton(onPressed: (){
                                    Navigator.of(context).pop();
                                      ...
                                      ), child: Text('Trở lại',style: TextStyle(color: Color(0xFFE4A11B)),)),
                                ),
                                TextButton(onPressed: (){}
                                    , style: TextButton.styleFrom(
                                      padding: EdgeInsets.only(left: 43,right: 43,top: 16,bottom: 16),
                                      primary: Colors.white,
                                      backgroundColor: Color(0xFFE4A11B), // Màu nền của nút
                                      shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(8.0), // Độ cong của đường biên
                                        side: BorderSide(color: Color(0xFFE4A11B)), // Đường biên màu xanh
                                      ),
